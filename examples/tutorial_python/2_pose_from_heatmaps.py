...
scales = [1]
class Param:
    caffemodel = dir_path + "/../../../models/pose/body_21/pose_iter_XXXXXX.caffemodel"
    prototxt = dir_path + "/../../../models/pose/body_21/pose_deploy.prototxt"
...
img = cv2.imread("/home/raaj/Desktop/save.png")
frame = func(img)
while 1:
